#!/usr/bin/env python3
"""Run ONE problem of mmiu through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one mmiu problem via TrustedRouter")
