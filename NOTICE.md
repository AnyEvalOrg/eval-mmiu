...
`eval-mmiu` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/mmiu`)
...
- `direct_url`: `https://huggingface.co/datasets/FanqingM/MMIU-Benchmark/resolve/{SHA}/{file}.zip`
- `huggingface`: `FanqingM/MMIU-Benchmark`
